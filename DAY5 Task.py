...
L1=['P','y','c','h','a','m']
print(L1)
print(L1[3])    # L[5] returns the item at index 5
print(L1[1:])   # L[1:] returns objects from 1 to the last object
print(L1[2:4])  # L[1:3] returns a new list, containing the objects between 1 and 3.
...
L.remove("h")         #removes the item h from the list
print(L)
